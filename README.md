...
- 🗄️ Work with SQL, PostgreSQL, SQLite and SQLAlchemy
- 🔐 Implement authentication, JWT and role-based access control
- 🤖 Build AI applications using RAG, LLMs, LangChain and Gemini
...
A Retrieval-Augmented Generation system that allows users to ask
context-aware questions from uploaded PDF documents.
